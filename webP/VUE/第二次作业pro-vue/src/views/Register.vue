    ...
    <div style="width: 400px; padding: 30px; background-color: white; border-radius: 5px;">
      ...
      <el-form :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="username">
          <el-input prefix-icon="el-icon-user" placeholder="请输入账�?" v-model="form.username"></el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input prefix-icon="el-icon-lock" placeholder="请输入密�?" show-password  v-model="form.password"></el-input>
        </el-form-item>
        <el-form-item prop="confirmPass">
          <el-input prefix-icon="el-icon-lock" placeholder="请确认密�?" show-password  v-model="form.confirmPass"></el-input>
        </el-form-item>
        <el-form-item>
